####################################################################
#######
#######Script Copied and Adjusted for Env-Arshad Taqvi
#######
...
[cmdletbinding(  
    ...
    End {  
      ...
      # $s1 = $ser.Replace("Server", "")
        ...
        $dd=date
        echo "$hn,$ser,$po,$type,$stat,$dd" | out-File $reportfile -Append
    }


    #c:\app\beacon\script\TestPort.ps1 -comp m903prd1 -port 1434 -tcp -UDPtimeout 10000
